...
## Project Structure
    ...
    ├── car_dealership_manageme_3  # Django project configurations
...
1. Clone this repo and `cd car_dealership_manageme_3`
...
2. Clone this repo and `cd car_dealership_manageme_3`
