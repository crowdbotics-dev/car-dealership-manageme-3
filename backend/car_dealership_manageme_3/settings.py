"""
Django settings for car_dealership_manageme_3 project.
...
ROOT_URLCONF = 'car_dealership_manageme_3.urls'
...
WSGI_APPLICATION = 'car_dealership_manageme_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "car_dealership_manageme_3 API",
    "DESCRIPTION": "API documentation for car_dealership_manageme_3 App",
    "VERSION": "v1",
}
